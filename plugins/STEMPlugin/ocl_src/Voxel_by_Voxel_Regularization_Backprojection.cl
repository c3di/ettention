...
__kernel void correct(int2 projectionResolution, __global float* projection, __global float* vol, __global float* ray_length_inside_volume, __constant ProjectionGeometry* projectionGeometry, __constant Matrix4x4* transform, __constant VolumeGeometry* volumeGeometry, __constant ConvergentBeamsParameter* convergentBeamsParameter, float lambda)
{
    ...
    {
        const float focalDifferenceBetweenImages = convergentBeamsParameter->focalDifferenceBetweenImages;
