...
namespace ettention
{
    ...
    public:
         ...
         */
        static Matrix4x4 RotationFromYawPitchRoll(float yawInDegree, float pitchInDegree, float rollInDegree);

        static Matrix4x4 PerspectiveProjection(const Vec3f& eyePos, const Vec3f& projectionPlaneBasePos, const Vec3f& projectionPlaneDx, const Vec3f& projectionPlaneDy, const Vec2ui& projectionPlaneResolution);
        static Matrix4x4 ParallelProjection(const Vec3f& frontPlaneBasePos, const Vec3f& backPlaneBasePos, const Vec3f& planeDx, const Vec3f& planeDy);
