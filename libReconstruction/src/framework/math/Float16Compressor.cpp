...
namespace ettention
{
    uint16_t Float16Compressor::_compress(float value)
    {
        Bits v, s;
        v.f = value;
    ...
    float Float16Compressor::_decompress(uint16_t value)
    {
        Bits v;
        v.ui = value;
    ...
    void Float16Compressor::compress(const float* input, uint16_t* output, size_t count)
    {
    ...
    void Float16Compressor::decompress(uint16_t* input, float* output, size_t count)
    {
        for(size_t i = 0; i < count; i++)
        {
