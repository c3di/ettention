...
if(MSVC)
	add_definitions(/wd4482) # disable "non-standard extension used" which will disappear in newer compilers anyways
	...
	add_definitions(/wd4006) # disable "symbol was already defined in X" which can occur when re-using opencl source code in several kernels
...
source_group("OpenCL generated" FILES ${TEMPORARY_OCL_FILES})
