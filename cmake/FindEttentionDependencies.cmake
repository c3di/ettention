...
#	message("CMake thinks this is 64-bit environment")
	set(POSSIBLE_LIB_SUFFIXES Win64 x64 x86_64 lib/Win64 lib/x86_64 lib/x64)
else(CMAKE_SIZEOF_VOID_P EQUAL 8)
#	message("CMake thinks this is 32-bit environment")
...
set(CLAMDFFT_INCLUDE_DIR ${CLAMDFFT_INCLUDE_DIR} CACHE INTERNAL "clAmdFft Include Directory")
set(CLAMDFFT_LIBRARIES ${CLAMDFFT_LIBRARY} CACHE INTERNAL "clAmdFft Libraries")

mark_as_advanced(CLAMDFFT_ROOT_DIR CLAMDFFT_INCLUDE_DIR CLAMDFFT_LIBRARIES)

find_package_handle_standard_args(clAmdFft REQUIRED_VARS CLAMDFFT_ROOT_DIR
  CLAMDFFT_INCLUDE_DIR CLAMDFFT_LIBRARIES)
