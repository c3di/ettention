...
public final class ComScriptManager extends BaseComScriptManager {
  ...
  private ComScript scriptEttentionsetup;
  ...
  public boolean loadEttentionsetup(AxisID axisID) {
	    // Assign the new ComScriptObject object to the appropriate reference
	    scriptEttentionsetup = loadComScript(
	        FileType.ETTENTIONSETUP_COMSCRIPT.getFileName(appManager, axisID), axisID, true,
	        false, false, false);
	    return scriptEttentionsetup != null;
  }
  ...
  public EttentionsetupParam getEttentionsetupParam(AxisID axisID) {
	    // Get a reference to the appropriate script object
	    ComScript ettentionsetup = scriptEttentionsetup;
	        
	    // Initialize a EttentionsetupParam object from the com script command object
	    EttentionsetupParam param = new EttentionsetupParam(appManager, axisID);
	    initialize(param, ettentionsetup, FileType.ETTENTIONSETUP_COMSCRIPT.getTypeString(appManager),
	        axisID, true, true);
	    return param;
  }
  ...
  public void saveEttentionsetup(EttentionsetupParam param, AxisID axisID) {
	    // Get a reference to the appropriate script object
	    ComScript script = scriptEttentionsetup;
	    modifyCommand(script, param, ProcessName.ETTENTIONSETUP.toString(), axisID, false, false);
  }
