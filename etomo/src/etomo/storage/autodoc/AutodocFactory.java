...
public final class AutodocFactory {
  ...
  public static final String ETTENTIONSETUP = "ettentionsetup";
  ...
  private static Autodoc ETTENTIONSETUP_INSTANCE = null;
  ...
  private static Autodoc getExistingAutodoc(String name) {
    ...
    if (name.equals(ETTENTIONSETUP)) {
        return ETTENTIONSETUP_INSTANCE;
    }
  ...
  public static void resetInstance(String name) {
    ...
    else if (name.equals(ETTENTIONSETUP)) {
        ETTENTIONSETUP_INSTANCE = null;
    }
