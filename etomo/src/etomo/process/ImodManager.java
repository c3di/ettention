...
public class ImodManager {
  ...
  public static final String ETTENTION_KEY = new String("Ettention output files");
  ...
  private static final String ettentionKey = ETTENTION_KEY;
  ...
  ImodState newImodState(String key, AxisID axisID, String datasetName, File file,
    ...
    if (key.equals(ETTENTION_KEY) && axisID != null) {
        return newEttention(fileList, axisID);
    }
  ...
  private ImodState newEttention(final File[] fileList, final AxisID axisID) {
	    ImodState imodState = new ImodState(manager, fileList, axisID);
	    imodState.setInitialSwapYZ(true);
	    return imodState;
  }
