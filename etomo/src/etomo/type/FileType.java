...
public final class FileType {
  ...
  public static final FileType SIRTSETUP_COMSCRIPT = FileType.getInstance(false, true,
      "sirtsetup", ".com");
  public static final FileType ETTENTIONSETUP_COMSCRIPT = FileType.getInstance(false, true,
	      "ettentionsetup", ".com");
  ...
  public static final FileType ETTENTION_OUTPUT_TEMPLATE = FileType
	      .getDerivedTemplateInstance(TILT_OUTPUT, ".rec_et", ImodManager.ETTENTION_KEY);
  ...
  public String toString() {
    ...
    if (this == ETTENTIONSETUP_COMSCRIPT) {
        return "ETTENTIONSETUP_COMSCRIPT";
    }
