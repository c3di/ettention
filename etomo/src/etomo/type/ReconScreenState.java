...
public final class ReconScreenState extends BaseScreenState {
  ...
  private final PanelHeaderState tomoGenEttentionHeaderState = new PanelHeaderState(
	      DialogType.TOMOGRAM_GENERATION.getStorableName() + ".Ettention" + HEADER_GROUP);
  ...
  public void store(Properties props, String prepend) {
    ...
    tomoGenEttentionHeaderState.store(props, prepend);
  ...
  public void load(Properties props, String prepend) {
    ...
    tomoGenEttentionHeaderState.load(props, prepend);
  ...
  public PanelHeaderState getTomoGenEttentionHeaderState() {
	    return tomoGenEttentionHeaderState;
  }
