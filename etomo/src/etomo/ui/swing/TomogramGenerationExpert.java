...
public final class TomogramGenerationExpert extends ReconUIExpert {
  ...
  public static final String ETTENTION_DONE = "ettentionDone";
  ...
  public void openDialog() {
    ...
    EttentionsetupParam ettentionsetupParam;
    if (comScriptMgr.loadEttentionsetup(axisID)) {
    	ettentionsetupParam = comScriptMgr.getEttentionsetupParam(axisID);
    }
    else {
      // create an empty param to get the defaults.
    	ettentionsetupParam = new EttentionsetupParam(manager, axisID);
    }
    setParameters(ettentionsetupParam);
  ...
  public void msgEttentionsetupSucceeded() {
	    //checkpoint();
  }
  ...
  public boolean startNextProcess(ProcessSeries.Process process,
    ...
    if (process.equals(ETTENTION_DONE)) {
        msgEttentionSucceeded();
        return true;
    }
    return false;
  }
  ...
  void saveDialog() {
    ...
    manager.updateEttentionSetupCom(axisID, dialog.getEttentionsetupDisplay(), false, false);
  ...
  private void setParameters(EttentionsetupParam param) {
	    if (dialog == null) {
	      return;
	    }
	    dialog.setParameters(param);
