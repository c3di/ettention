...
public final class ProcessResultDisplayFactory implements
  ...
  private final ProcessResultDisplay ettentionsetup = Run3dmodButton
	      .getDeferredToggle3dmodInstance("Run Ettention", DialogType.TOMOGRAM_GENERATION);
  ...
  private final ProcessResultDisplay useEttention = MultiLineButton.getToggleButtonInstance(
	      "Use Ettention Output File", DialogType.TOMOGRAM_GENERATION);
  ...
  private void initialize() {
    ...
    addDependency(ettentionsetup);
    addDependency(useEttention);
    // combination
    ...
    ettentionsetup.setScreenState(screenState);
    useEttention.setScreenState(screenState);
    // combination
    ...
    addDependents(ettentionsetup);
    addDependents(useEttention);
    // combination
    ...
    ettentionsetup.addDependentDisplay(useEttention);
  ...
  public ProcessResultDisplay getEttentionsetup() {
	    return ettentionsetup;
  }
  ...
  public ProcessResultDisplay getUseEttention() {
	    return useEttention;
  }
