...
__kernel void computeErosion(__global float *src, __global float *structElement, __global float *result, int sizeX,  int sizeY, int structWidth, int structHeight)
{
