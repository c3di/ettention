...
namespace ettention
{
    VolumeProperties::VolumeProperties(Voxel::DataType voxelType, const VolumeParameterSet& volumeParameterSet, boost::optional<unsigned int> subVolumeCount)
        : voxelType(voxelType)
    ...
    void VolumeProperties::init(boost::optional<unsigned int> subVolumeCount)
    {
        ...
        setSubVolumeCount(subVolumeCount == boost::none ? resolution.z : *subVolumeCount);
    }
