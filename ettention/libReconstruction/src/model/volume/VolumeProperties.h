...
namespace ettention
{
    ...
    {
    public:
        VolumeProperties(Voxel::DataType voxelType, const VolumeParameterSet& volumeParameterSet, boost::optional<unsigned int> subVolumeCount);
        ~VolumeProperties();

        void init(boost::optional<unsigned int> subVolumeCount);
