...
namespace ettention
{
    ...
    public:
        ...
        ByteVolume(const Vec3ui& resolution, boost::optional<float> initValue, boost::optional<unsigned int> subVolumeCount = 1U, boost::optional<float> maximumInputFloatValue = 1.0f);
        ByteVolume(const Vec3ui& resolution, const float* initialData, boost::optional<unsigned int> subVolumeCount = 1U, boost::optional<float> maximumInputFloatValue = 1.0f);
        ByteVolume(VolumeParameterSet* volumeParameterSet, boost::optional<unsigned int> subVolumeCount = 1U, boost::optional<float> maximumInputFloatValue = 1.0f);
        ~ByteVolume();
