...
namespace ettention
{
    ...
    public:
        ...
        GPUMapped(CLAbstractionLayer* clStack, ResolutionType resolution, bool useImage = false, Voxel::DataType voxelType = Voxel::DataType::FLOAT_32);
        GPUMapped(CLAbstractionLayer* clStack, T* objectOnCPU, bool useImage = false, Voxel::DataType voxelType = Voxel::DataType::FLOAT_32);
        GPUMapped(T* objectOnCPU, CLMemBuffer* bufferOnGPU, bool useImage = false, Voxel::DataType voxelType = Voxel::DataType::FLOAT_32);
