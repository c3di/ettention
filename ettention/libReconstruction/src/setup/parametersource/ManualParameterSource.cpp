...
namespace ettention
{
    ...
    ParameterSource::LogLevel ManualParameterSource::getLogLevel() const
    {
        return ParameterSource::LogLevel::ALL;
    }

    void ManualParameterSource::setLogLevel(const LogLevel level)
    {
        //
    }
