...
namespace ettention
{
    ...
    float XMLParameterSource::getFloatParameter(std::string parameterName, std::string attributeName) const
    {
        return retrieveNode(parameterName).get<float>("<xmlattr>." + attributeName);
    }
