...
public:
    ...
    const std::string inputDS1{"120604_C4dep_10_2048_z11"};
    const std::string inputDS2{"MYC_FA_D5_4096_z1"};
    const std::string inputDS3{"HPFCere2a_z1"};
    const std::string inputDS4{"SKBR3_EGF-AU_ERB2-B_S-QD_033_1024x884"};

    const std::string markerDS1{"marker_from_C4_black_23"};
    const std::string markerDS2{"marker_from_MYC_black_63"};    
    const std::string markerDS3{"marker_from_HPF_white_12"};
    const std::string markerDS4square{"particle_from_SKBR3_black_11"};
    const std::string markerDS4rectan{"particle_from_SKBR3_black_9x7"};

    const std::string groundDS1{"ground_particles_C4dep.txt"};
    const std::string groundDS2{"ground_particles_MYC.txt"};
    const std::string groundDS3{"ground_particles_source.txt"};
    const std::string groundDS4{"ground_particles_SKBR3.txt"};
