...
class RMSKernelTest : public TestBase
{
public:
...
TEST_F(RMSKernelTest, RMSKernel_Constructor)
{
    ...
    GPUMapped<Image>* image = new GPUMapped<Image>(framework->getOpenCLStack(), resolution);
...
TEST_F(RMSKernelTest, RMSKernel_Execute)
{
    ...
    GPUMapped<Image>* mappedImage = new GPUMapped<Image>(framework->getOpenCLStack(), image);
