...
TEST_F(ConvolutionOperatorTest, VolumeConvolutionKernel)
{
    ...
    VolumeConvolutionKernel* kernel = new VolumeConvolutionKernel(framework, input->getMappedSubVolume(), output->getMappedSubVolume(), convolutionKernel->getMappedSubVolume());
    kernel->run();
    delete kernel;
...
TEST_F(ConvolutionOperatorTest, VolumeConvolutionOperator)
{
    ...
    VolumeConvolutionOperator* convOperator = new VolumeConvolutionOperator(framework, input, output, convolutionKernel->getMappedSubVolume());
    convOperator->run();
    delete convOperator;
